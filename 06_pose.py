...
def main() -> None:
    """ Main Function """
    jog: Path = Path("data/images/jog.png")

    model = load_pretrained_model("yolo26n-pose.pt", task_type="pose")
    with Yolo(model, jog, display=True) as yolo:
